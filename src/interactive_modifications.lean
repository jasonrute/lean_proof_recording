...
@[reducible] protected meta def recorded_itactic (tactic_name: string) (arg_num : nat) : lean.parser (tactic unit) := 
lean.parser.val $ record tactic_name arg_num "itactic" lean.parser.itactic_reflected
