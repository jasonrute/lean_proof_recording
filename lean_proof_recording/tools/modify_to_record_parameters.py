...
from lean_proof_recording.tokenizer import LeanFile
            ...
            for token in line:
                if token.string in ["parse", "itactic"]:
                    ...
                    if left is None or left.string != "def":
                        print(
                            "BAD LEFT:", left.string, " ", "".join(t.string for t in line).strip()
                        )
                        continue
                    ...
                    if (
                        ...
                        print(
                            "BAD RIGHT:", right.string, " ", "".join(t.string for t in line).strip()
                        )
                        continue
