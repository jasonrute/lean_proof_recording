...
python3 -m lean_proof_recording.pipeline.insert_proof_recording_code --sexp
...
python3 -m lean_proof_recording.pipeline.run_lean_and_save_results src/all.lean "$DATA_DIR"
