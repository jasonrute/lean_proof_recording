...
def get_split(arg, train_threshold=0.80, valid_threshold=0.845):
    ...
    if float_hash < train_threshold: return "train"
    elif float_hash < valid_threshold: return "valid"
    else: return "test"
...
def _main(decls_file: str, valid_frac: float, test_frac: float, dest_dir: str):
    ...
    train_threshold = 1. - valid_frac - test_frac
    valid_threshold = 1. - test_frac
